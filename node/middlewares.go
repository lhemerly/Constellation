...
// RateLimitMiddleware limits the rate of requests using a simple token bucket algorithm.
// rate is the number of tokens added per second, and burst is the maximum tokens the bucket can hold.
...
// If the validation fails, it short-circuits and returns the error.
